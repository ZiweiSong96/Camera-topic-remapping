...
class ImageRemap : public rclcpp::Node{
  public:
    ImageRemap():Node("image_remap")
    {
      ...
      image_subscription_ = create_subscription<sensor_msgs::msg::Image>(
        ...
        std::bind(&ImageRemap::imageCallback,this,std::placeholders::_1)
      );
...
//  (void) argv;
  ...
  auto node = std::make_shared<ImageRemap>();
  rclcpp::spin(node);
